...
export const menuItems: Record<Exclude<MenuCategory, 'vins'>, ExtendedMenuItem[]> = {
  entrees: [
    ...
    },
    {
      ...
      price: '38',
      image: 'https://images.unsplash.com/photo-1606731219412-4a2e0aa12e12?q=80&w=2071&auto=format&fit=crop',
      heroImage: 'https://images.unsplash.com/photo-1606731219412-4a2e0aa12e12?q=80&w=2071&auto=format&fit=crop',

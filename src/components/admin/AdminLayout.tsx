...
const AdminLayout = () => {
  ...
  return (
    <div className={cn("h-screen bg-background flex overflow-hidden admin-theme", theme === 'dark' && 'dark')}>
      ...
      {/* Sidebar */}
      <aside className={cn(
        "w-72 bg-sidebar border-r border-primary/10 fixed lg:static h-full z-40 transition-transform duration-300 shadow-sm flex flex-col",
      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden">
        <AdminHeader />
        <main className="flex-1 p-4 lg:p-8 pt-4 lg:pt-6 overflow-y-auto bg-muted/30">
          <Outlet />
        </main>
      </div>
    </div>

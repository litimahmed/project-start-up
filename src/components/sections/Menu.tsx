  ...
  return <section id="menu" ref={sectionRef} className="section-padding relative overflow-hidden bg-offwhite">
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-6 lg:gap-8">
              {menuData[activeCategory].map((item, index) => <div key={item.name} className="group relative rounded-2xl overflow-hidden transition-all duration-700 bg-white shadow-lg" style={{
